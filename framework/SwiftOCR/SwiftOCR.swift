...
open class SwiftOCR {
    ...
    open func preprocessImageForOCR(_ image:OCRImage) -> OCRImage {
        ...
        func getDodgeBlendImage(_ inputImage: OCRImage) -> OCRImage {
            ...
            var processedImage:OCRImage? = dodgeBlendFilter.imageFromCurrentFramebuffer(with: .up)
        ...
        var processedImage:OCRImage? = thresholdFilter.imageFromCurrentFramebuffer(with: .up)
